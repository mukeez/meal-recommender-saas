...
class RecipeLLMService(BaseLLMService):
    ...
    async def _build_prompt(self, request: RecipeSuggestionRequest) -> str:
        ...
        Format the response as a JSON object with a "suggestions" property containing an array of recipe objects. Each recipe object must include "name", "description", "ingredients", "recipe", "protein", "carbs", "fat", and "calories".
