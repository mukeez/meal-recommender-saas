...
async def log_meal(
    ...
    protein: float = Form(..., description="Protein amount in grams", gt=0),
    carbs: float = Form(..., description="Carbohydrate amount in grams", gt=0),
    fat: float = Form(..., description="Fat amount in grams", gt=0),
    calories: float = Form(..., description="Total calories", gt=0),
    ...
    amount: float = Form(1.0, description="Amount/quantity of the serving unit", gt=0),
...
async def update_meal(
    ...
    description: Optional[str] = Form(None, description="Description of the meal"),
    protein: Optional[float] = Form(None, description="Protein amount in grams", gt=0),
    carbs: Optional[float] = Form(None, description="Carbohydrate amount in grams", gt=0),
    fat: Optional[float] = Form(None, description="Fat amount in grams", gt=0),
    calories: Optional[float] = Form(None, description="Total calories", gt=0),
    notes: Optional[str] = Form(None, description="Additional notes about the meal"),
    ...
    amount: Optional[float] = Form(None, description="Amount/quantity of the serving unit", gt=0),
