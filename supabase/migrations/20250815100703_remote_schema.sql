...
-- Create types conditionally to avoid "already exists" errors
DO $$
BEGIN
    ...
    -- Create unit_preference_type enum if it doesn't exist
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'unit_preference_type') THEN
...
DO $$ 
BEGIN
    -- contact_submissions constraints
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'contact_submissions_reference_id_key') THEN
        ALTER TABLE ONLY "public"."contact_submissions" ADD CONSTRAINT "contact_submissions_reference_id_key" UNIQUE ("reference_id");
    END IF;
    ...
    -- meal_feedback constraints
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'meal_feedback_pkey') THEN
        ALTER TABLE ONLY "public"."meal_feedback" ADD CONSTRAINT "meal_feedback_pkey" PRIMARY KEY ("id");
    END IF;

    -- meal_logs constraints
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'meal_logs_pkey') THEN
        ALTER TABLE ONLY "public"."meal_logs" ADD CONSTRAINT "meal_logs_pkey" PRIMARY KEY ("id");
    END IF;
    ...
    -- otp constraints
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'otp_pkey') THEN
        ALTER TABLE ONLY "public"."otp" ADD CONSTRAINT "otp_pkey" PRIMARY KEY ("email");
    END IF;

    -- product_feedback constraints
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'product_feedback_pkey') THEN
        ALTER TABLE ONLY "public"."product_feedback" ADD CONSTRAINT "product_feedback_pkey" PRIMARY KEY ("id");
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'products_pkey') THEN
        ALTER TABLE ONLY "public"."products" ADD CONSTRAINT "products_pkey" PRIMARY KEY ("barcode");
    END IF;
    ...
    -- referral_tracking constraints
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'referral_tracking_pkey') THEN
        ALTER TABLE ONLY "public"."referral_tracking" ADD CONSTRAINT "referral_tracking_pkey" PRIMARY KEY ("id");
    END IF;
    ...
    -- session_tokens constraints
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'session_tokens_pkey') THEN
        ALTER TABLE ONLY "public"."session_tokens" ADD CONSTRAINT "session_tokens_pkey" PRIMARY KEY ("email");
    END IF;

    -- user_preferences constraints
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'unique_user_preferences') THEN
        ALTER TABLE ONLY "public"."user_preferences" ADD CONSTRAINT "unique_user_preferences" UNIQUE ("user_id");
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'user_profiles_email_key') THEN
        ALTER TABLE ONLY "public"."user_profiles" ADD CONSTRAINT "user_profiles_email_key" UNIQUE ("email");
    END IF;

    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'user_profiles_fcm_token_key') THEN
        ALTER TABLE ONLY "public"."user_profiles" ADD CONSTRAINT "user_profiles_fcm_token_key" UNIQUE ("fcm_token");
    END IF;
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'webhook_events_event_id_key') THEN
        ALTER TABLE ONLY "public"."webhook_events" ADD CONSTRAINT "webhook_events_event_id_key" UNIQUE ("event_id");
    END IF;
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'dishes_country_idx') THEN
        CREATE INDEX "dishes_country_idx" ON "public"."dishes" USING "btree" ("country");
    END IF;

    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'dishes_embedding_idx') THEN
        CREATE INDEX "dishes_embedding_idx" ON "public"."dishes" USING "ivfflat" ("embedding" "extensions"."vector_cosine_ops") WITH ("lists"='100');
    END IF;

    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'dishes_nutritional_info_idx') THEN
        CREATE INDEX "dishes_nutritional_info_idx" ON "public"."dishes" USING "gin" ("nutritional_info");
    END IF;

    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_contact_submissions_client_email') THEN
        CREATE INDEX "idx_contact_submissions_client_email" ON "public"."contact_submissions" USING "btree" ("client_email");
    END IF;

    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_contact_submissions_priority_status') THEN
        CREATE INDEX "idx_contact_submissions_priority_status" ON "public"."contact_submissions" USING "btree" ("priority", "status");
    END IF;

    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_contact_submissions_reference_id') THEN
        CREATE INDEX "idx_contact_submissions_reference_id" ON "public"."contact_submissions" USING "btree" ("reference_id");
    END IF;

    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_contact_submissions_status') THEN
        CREATE INDEX "idx_contact_submissions_status" ON "public"."contact_submissions" USING "btree" ("status");
    END IF;

    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_contact_submissions_submitted_at') THEN
        CREATE INDEX "idx_contact_submissions_submitted_at" ON "public"."contact_submissions" USING "btree" ("submitted_at" DESC);
    END IF;

    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_restaurants_geom') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_webhook_events_event_id') THEN
        CREATE INDEX "idx_webhook_events_event_id" ON "public"."webhook_events" USING "btree" ("event_id");
    END IF;

    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'meal_logs_created_at_idx') THEN
        CREATE INDEX "meal_logs_created_at_idx" ON "public"."meal_logs" USING "btree" ("created_at");
    END IF;

    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'meal_logs_meal_time_idx') THEN
        CREATE INDEX "meal_logs_meal_time_idx" ON "public"."meal_logs" USING "btree" ("meal_time");
    END IF;

    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'meal_logs_user_id_idx') THEN
        CREATE INDEX "meal_logs_user_id_idx" ON "public"."meal_logs" USING "btree" ("user_id");
    END IF;
END $$;

DROP TRIGGER IF EXISTS "trigger_update_contact_submissions_updated_at" ON "public"."contact_submissions";
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'meal_feedback_user_id_fkey') THEN
        ALTER TABLE ONLY "public"."meal_feedback" ADD CONSTRAINT "meal_feedback_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."user_profiles"("id");
    END IF;

    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'meal_logs_user_id_fkey') THEN
        ALTER TABLE ONLY "public"."meal_logs" ADD CONSTRAINT "meal_logs_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."user_profiles"("id");
    END IF;

    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'notifications_user_id_fkey') THEN
        ALTER TABLE ONLY "public"."notifications" ADD CONSTRAINT "notifications_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."user_profiles"("id");
    END IF;

    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'product_feedback_user_id_fkey') THEN
        ALTER TABLE ONLY "public"."product_feedback" ADD CONSTRAINT "product_feedback_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."user_profiles"("id");
    END IF;

    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'referral_codes_generated_by_fkey') THEN
        ALTER TABLE ONLY "public"."referral_codes" ADD CONSTRAINT "referral_codes_generated_by_fkey" FOREIGN KEY ("generated_by") REFERENCES "public"."user_profiles"("id");
    END IF;

    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'referral_tracking_influencer_id_fkey') THEN
        ALTER TABLE ONLY "public"."referral_tracking" ADD CONSTRAINT "referral_tracking_influencer_id_fkey" FOREIGN KEY ("influencer_id") REFERENCES "public"."user_profiles"("id");
    END IF;

    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'referral_tracking_referred_user_id_fkey') THEN
        ALTER TABLE ONLY "public"."referral_tracking" ADD CONSTRAINT "referral_tracking_referred_user_id_fkey" FOREIGN KEY ("referred_user_id") REFERENCES "public"."user_profiles"("id");
    END IF;

    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'user_preferences_user_id_fkey') THEN
        ALTER TABLE ONLY "public"."user_preferences" ADD CONSTRAINT "user_preferences_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."user_profiles"("id") ON DELETE CASCADE;
    END IF;
...
BEGIN
    ...
    DROP POLICY IF EXISTS "Service role can access all preferences" ON "public"."user_preferences";
    ...
    DROP POLICY IF EXISTS "meal_logs_delete_policy" ON "public"."meal_logs";
    CREATE POLICY "meal_logs_delete_policy" ON "public"."meal_logs" FOR DELETE USING (("auth"."uid"() = "user_id"));

    DROP POLICY IF EXISTS "meal_logs_insert_policy" ON "public"."meal_logs";
    ...
    DROP POLICY IF EXISTS "meal_logs_update_policy" ON "public"."meal_logs";
...
GRANT ALL ON FUNCTION "public"."search_similar_dishes"("query_embedding" "extensions"."vector", "match_threshold" double precision, "match_count" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."search_similar_dishes"("query_embedding" "extensions"."vector", "match_threshold" double precision, "match_count" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_similar_dishes"("query_embedding" "extensions"."vector", "match_threshold" double precision, "match_count" integer) TO "service_role";

GRANT ALL ON FUNCTION "public"."search_similar_dishes_by_country"("query_embedding" "extensions"."vector", "target_country" "text", "match_threshold" double precision, "match_count" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."search_similar_dishes_by_country"("query_embedding" "extensions"."vector", "target_country" "text", "match_threshold" double precision, "match_count" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."search_similar_dishes_by_country"("query_embedding" "extensions"."vector", "target_country" "text", "match_threshold" double precision, "match_count" integer) TO "service_role";
